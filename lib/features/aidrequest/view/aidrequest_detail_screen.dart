...
class AidRequestDetailScreen extends StatefulWidget {
  const AidRequestDetailScreen({required this.aidRequestId, super.key});
...
class _AidRequestDetailScreenState extends BaseState<AidRequestDetailScreen> {
  ...
  void initState() {
    ...
    context
        .read<AidrequestBloc>()
        .add(FetchAidrequestDetail(widget.aidRequestId));
  }
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 8),
                    if (aidRequest.document != null)
                      Text(
                        'Document: ${aidRequest.document}',
                        style: const TextStyle(fontSize: 16),
                      ),
                    const SizedBox(height: 8),
                    if (aidRequest.photo != null)
                      Image.network(aidRequest.photo!),
